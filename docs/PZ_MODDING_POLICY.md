...
Last reviewed for this repository: **2026-08-31**, during preparation of the v1.0.0 Steam Workshop Release Candidate. The live policy reviewed on that date permits voluntary monetary/gift donations but prohibits donor-exclusive mods, in-mod content, or bonuses.
...
5. **No prohibited commercialization**
   ...
   - Voluntary support links are permitted only when the complete mod and all functionality remain equally available to non-donors.
   - Enshrouded Sleep's public support links do not unlock access, content, bonuses, configuration, support priority, or gameplay functionality.
